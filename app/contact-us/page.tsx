...
const ContactPage = () => {
  return (
   <div className="min-h-screen flex items-center justify-center bg-gray-600 p-10 mg-auto">
    ...
    <section className="p-8 flex flex-col justify-center">
      ...
      <form action="#" className="space-y-4">
        ...
        <div>
          ...
          <input type="email" id="email" name="email" placeholder="Enter your email@.com" 
          className="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none"/>
        </div>
